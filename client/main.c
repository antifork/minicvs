 ...
 *
 *
 * A bit messs - cygnus@unixwave.org
 * 25-04-2001 * Just started to review
 */
...

{
    ...
    { "init",     NULL,       NULL,        init },
    { "tlsserver",  NULL,       NULL,        server }, /* placeholder */
    { "log",      "lo",       "rlog",      cvslog },
...
static const char *const cmd_usage[] =
{
    ...
    "	     tlsserver    Password server using TLS protocol\n",
...
void
date_to_internet (char *dest, char *source, size_t dest_sz)
    
{
    ...
    snprintf (dest,dest_sz,"%d %s %d %02d:%02d:%02d -0000", day,
